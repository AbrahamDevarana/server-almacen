...
function mailExternalNewUser (usuario, password) {
            ...
            <tr>
                <td>
                    <div style="padding: 25px 50px 0px">
                        ...
                        <p style="color:#646375;padding-top: 15px;font-size: 16px;">
                            Tu usuario es: <span style="font-weight: bold;">${usuario.email}</span>
                        </p>
                        <p style="color:#646375;padding-bottom: 15px;font-size: 16px;">
                            Contraseña: <span style="font-weight: bold;">${password}</span>
                        </p>
                        
    
                        <p style="color:#646375;padding: 15px 0;font-size: 16px;">
                            Bienvenid@ al Software de Gestión de Obra, módulo de Bitácora Digital de Obra, en este momento tenemos listo tu usuario, para que puedas acceder al sistema y comenzar a utilizarlo.
                        </p>
                        <p style="color:#646375;padding-top: 15px;font-size: 16px;">
                            Aquí podrás encontrar una 
                            <a style="color:#d64767;padding: 15px;font-size: 16px; text-decoration:none;" href="https://linktr.ee/devarana_bitacora" target="_blank">
                            Guía de Usuario
                            </a> de como usar la plataforma:
                        </p>
